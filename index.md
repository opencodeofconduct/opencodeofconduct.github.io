...
* **Be careful in the words that you choose**: we are a community of professionals, and we conduct ourselves professionally. Be kind to others. Do not insult or put down other participants. Harassment and other exclusionary behavior aren't acceptable. We interpret the term "harassment" as including the definition in the [Geek Feminism Code of Conduct](http://geekfeminism.org/about/code-of-conduct/) or [Citizen Code of Conduct](http://citizencodeofconduct.org/) as examples; if you have any lack of clarity about what might be included in that concept, please read their definitions. This includes, but is not limited to:
